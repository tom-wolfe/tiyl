...
export class Life {
  ...
  static adventure(): string {
    ...
    switch (true) {
      case r < 11: return `You nearly died. You have nasty scars on your body, and you are missing an ear, `
        + `${Random.dice('1d3')} fingers, or ${Random.dice('1d4')} toes.`;
      ...
      case r < 100: return `You found a considerable amount of treasure on your adventure. `
        + `You have ${Random.dice('1d20') + 50} gp left from your share of it.`;
  ...
  static boon(): string {
    switch (Random.dice('1d10')) {
      ...
      case 6: return 'You found ' + Items.trinket();
      ...
      case 10: return `A distant relative left you a stipend that enables you to live at the comfortable lifestyle for `
        + `${Random.dice('1d20')} years. If you choose to live at a higher lifestyle, `
  ...
  static punishment() {
    ...
    switch (true) {
      ...
      case r < 13: return `You were caught and convicted. You spent time in jail, chained to an oar, or performing hard labor. `
        + `You served a sentence of ${Random.dice('1d4')} years or succeeded in escaping after that much time.`;
    }
  }
  ...
  static supernatural() {
    ...
    switch (true) {
      ...
      case r < 16: return `A devil tempted you. Make a DC 10 Wisdom saving throw. On a failed save, your alignment shifts one step toward `
        + `evil (if it\'s not evil already), and you start the game with an additional ${Random.dice('1d20') + 50} gp.`;
  ...
  static tragedy() {
    switch (Random.dice('1d12')) {
      ...
      case 5:
        return `You were imprisoned for a crime you didn't commit and spent ${Random.dice('1d6')} years at hard labor, `
      ...
      case 12: return `A current or prospective romantic partner of yours died. `
        + `Cause of death: ${Life.causeOfDeath()}.` + (Random.bool(8) ? ' It was your fault.' : '');
    }
  }
  ...
  static weirdStuff() {
    switch (Random.dice('1d12')) {
      ...
      case 7: return `You went insane for ${Random.dice('1d6')} years and recently regained your sanity. `
  ...
  static event(previous: number[]): string {
    ...
    switch (true) {
      ...
      case r < 41: return `You made an enemy of an adventuring ${Classes.random().name} `
        + (Random.bool() ? 'but it wasn\'t your fault.' : 'and it was your fault.');
      case r < 51: return `You made a friend of an adventuring ${Classes.random().name}.`;
      case r < 71: return `You spent time working in a job related to your background.`
        + ` Start the game with an extra ${Random.dice('2d6')} gp.`;
  ...
  static occupation() {
    ...
    switch (true) {
      ...
      case r < 11: return 'works as an adventuring ' + Classes.random().name;
